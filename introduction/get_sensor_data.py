...
* Task: get the current joint angle and temperature of joint HeadYaw
  Ermitteln Sie den aktuellen Gelenkwinkel und die Temperatur des Gelenkkopfes

* Hint: The current sensor data of robot are store in perception (class Perception in spark_agent.py)
  Die aktuellen Sensordaten des Roboters werden in der Wahrnehmung gespeichert (Klasse Perception in spark_agent.py).
